...
class MemoryOptimizer {
  ...
  static Future<void> requestGarbageCollection() async {
    try {
  ...
  /// Check if MemoryOptimizer is initialized
  static bool get isInitialized => _isInitialized;

  /// Get the last cleanup time
  static DateTime? getLastCleanupTime() => _lastCleanupTime;

  /// Reduce image cache size for low memory situations
  static void reduceImageCacheSize() {
    try {
      ...
      debugPrint('📉 Image cache size reduced');
    } catch (e) {
      debugPrint('⚠️ Failed to reduce image cache size: $e');
    }
  }
  ...
  static Future<void> performEmergencyCleanup() async {
    try {
      ...
      // Reduce cache sizes to minimum
      PaintingBinding.instance.imageCache.maximumSize = 10;
      PaintingBinding.instance.imageCache.maximumSizeBytes = 8 << 20; // 8MB
      ...
      debugPrint('⚠️ Emergency cleanup failed: $e');
    }
  }
}
