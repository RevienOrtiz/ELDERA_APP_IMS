...
class AppTheme {
  /// High-contrast theme to improve readability for seniors
  static ThemeData get highContrastTheme {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        ...
        onBackground: AppColors.pureBlack,
      ...
      textTheme: const TextTheme(
        ...
        bodyLarge: TextStyle(color: AppColors.pureBlack, fontSize: 18),
        bodyMedium: TextStyle(color: AppColors.pureBlack, fontSize: 16),
        bodySmall: TextStyle(color: AppColors.pureBlack, fontSize: 14),
      ...
      inputDecorationTheme: const InputDecorationTheme(
        ...
        labelStyle: TextStyle(color: AppColors.pureBlack, fontSize: 16),
        hintStyle: TextStyle(color: AppColors.pureBlack, fontSize: 16),
      ...
      snackBarTheme: const SnackBarThemeData(
        backgroundColor: AppColors.pureBlack,
        contentTextStyle: TextStyle(color: AppColors.pureWhite, fontSize: 18),
  ...
  static Color _getOptimalTextColor(Color backgroundColor, bool isLargeText) {
    final whiteContrast =
        AppColors.calculateContrastRatio(AppColors.pureWhite, backgroundColor);
    final darkContrast = AppColors.calculateContrastRatio(
        AppColors.textOnWhite, backgroundColor);
