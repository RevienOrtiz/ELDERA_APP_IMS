...
class IMSWebhookHandler {
  ...
  static Future<void> initialize() async {
    try {
      // Use default configuration since webhook/config endpoint is not available
      _webhookSecret = 'default_webhook_secret';
      _maxRequestsPerMinute = 60; // Default rate limit
      print('IMSWebhookHandler initialized with default configuration');
    } catch (e) {
