...
class CalendarIntegrationService {
  ...
  Future<bool> addAnnouncementToCalendar(Announcement announcement) async {
    ...
    try {
      ...
      if (result?.isSuccess == true) {
        debugPrint(
            'Successfully added event to calendar: ${LanguageService.instance.translateFreeText(announcement.what)}');
        return true;
      } else {
  ...
  Future<bool> removeAnnouncementFromCalendar(String announcementId) async {
    ...
    try {
      ...
      final result =
          await _deviceCalendarPlugin.deleteEvent(_defaultCalendarId!, eventId);
