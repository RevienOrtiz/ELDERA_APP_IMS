            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <a href="{{ route('seniors.benefits.view', $application->id) }}" class="btn btn-sm btn-primary" title="View">
                            <i class="fas fa-eye"></i> View
                        </a>
                        <a href="{{ route('seniors.benefits.edit', $application->id) }}" class="btn btn-sm btn-warning" title="Edit">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <button type="button" class="btn btn-sm btn-danger" title="Delete" onclick="showDeleteModal('{{ $application->id }}', '{{ $application->senior ? $application->senior->first_name . ' ' . $application->senior->last_name : 'N/A' }}', 'benefits')">
