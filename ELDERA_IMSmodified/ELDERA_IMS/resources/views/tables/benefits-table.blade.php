            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        ...
                        <button type="button" class="btn btn-sm btn-danger" title="Delete" onclick="showDeleteModal('{{ $application->id }}', '{{ $application->senior ? ($application->senior->last_name . ', ' . $application->senior->first_name . ($application->senior->middle_name ? ' ' . $application->senior->middle_name : '') . ($application->senior->name_extension ? ' ' . $application->senior->name_extension : '')) : 'N/A' }}', 'benefits')">
