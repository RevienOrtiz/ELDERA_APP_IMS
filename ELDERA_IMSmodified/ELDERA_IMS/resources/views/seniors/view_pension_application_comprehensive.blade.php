...
<div id="deleteModal" class="modal-overlay" style="display: none;">
    <div class="modal-container">
        ...
        <h2 class="modal-title">Delete Pension Application</h2>
        <p class="modal-message" id="deleteMessage">Are you sure you want to delete this pension application? This action cannot be undone.</p>
...
.status-received { background-color: #17a2b8; color: #fff; }
    ...
    <script>
        function confirmEdit(seniorId, seniorName) {
            if (confirm(`Are you sure you want to edit the pension application of ${seniorName}?`)) {
                window.location.href = `{{ route('seniors.pension.edit', $application->id) }}`;
            }
        }
...
function showDeleteModal(id, name) {
    deleteItemId = id;
    document.getElementById('deleteMessage').textContent = `Are you sure you want to delete the pension application of "${name}"? This action cannot be undone.`;
...
function deleteSenior() {
    if (deleteItemId) {
        ...
        form.method = 'POST';
        form.action = `/delete-pension-application/${deleteItemId}`;
