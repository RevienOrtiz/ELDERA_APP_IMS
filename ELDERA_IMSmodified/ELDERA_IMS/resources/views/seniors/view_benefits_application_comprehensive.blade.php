                  ...
                  <div class="form-section">
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-3">
                          ...
                          <div class="button-group">
                              <a href="{{ route('seniors.benefits.edit', $application->id) }}" class="action-btn edit-btn">
...
<div id="deleteModal" class="modal-overlay" style="display: none;">
    <div class="modal-container">
        ...
        <h2 class="modal-title">Delete Benefits Application</h2>
        <p class="modal-message" id="deleteMessage">Are you sure you want to delete this benefits application? This action cannot be undone.</p>
        <div class="modal-actions">
            <button class="modal-btn modal-btn-cancel" onclick="hideDeleteModal()">Cancel</button>
            <button class="modal-btn modal-btn-confirm" id="confirmDeleteBtn" onclick="deleteSenior()">Yes, Proceed</button>
        </div>
    </div>
</div>
...
.status-received { background-color: #17a2b8; color: #fff; }
    ...
    <script>
        function confirmEdit(seniorId, seniorName) {
            if (confirm(`Are you sure you want to edit the benefits application of ${seniorName}?`)) {
                window.location.href = `{{ route('seniors.benefits.edit', $application->id) }}`;
            }
        }
...
function showDeleteModal(id, name) {
    deleteItemId = id;
    document.getElementById('deleteMessage').textContent = `Are you sure you want to delete the benefits application of "${name}"? This action cannot be undone.`;
...
function deleteSenior() {
    if (deleteItemId) {
        ...
        form.method = 'POST';
        form.action = `/delete-benefits-application/${deleteItemId}`;
